...
- **Ingested Data**: This connector collects threat indicator anomalies (such as file modifications, renames, deletions, and ransomware alerts) from the Commvault `/Client/Anomaly` API endpoint.
