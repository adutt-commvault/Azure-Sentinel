...
|---|---|---|
| 3.0.5 | 15-05-2026 | Replace Events API with Threat Indicators API (`GET /Client/Anomaly`); update analytic rule to remove stale event code filter |
| 3.0.4 | 05-03-2025 | Migrate to new data ingestion model via DCR & DCE setup |
| 3.0.3 | 12-09-2024 | Enhanced **Data connector** with configurable event collection and streamlined deployment |
